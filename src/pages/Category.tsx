...
const worksheetsByGradeAndSubject: Record<string, Record<string, any[]>> = {
  ...
  "grade-3": {
    math: [
      { id: 1, title: "Addition Worksheet 1", preview: mathAdditionImg, category: "Math", grade: "Grade 3" },
      { id: 2, title: "Addition Worksheet 2", preview: mathAdditionImg, category: "Math", grade: "Grade 3" },
      { id: 20, title: "Multiplication Tables", preview: mathMultiplicationImg, category: "Math", grade: "Grade 3" },
      { id: 44, title: "Division Practice", preview: mathDivisionImg, category: "Math", grade: "Grade 3" },
    ],
    english: [
      { id: 21, title: "Grammar Basics", preview: englishGrammarImg, category: "English", grade: "Grade 3" },
      { id: 45, title: "Reading Comprehension", preview: englishComprehensionImg, category: "English", grade: "Grade 3" },
    ],
    science: [
      { id: 22, title: "Water Cycle", preview: scienceWaterCycleImg, category: "Science", grade: "Grade 3" },
    ],
    computer: [
      { id: 111, title: "Parts of a Computer", preview: computerBasicsImg, category: "Computer Science", grade: "Grade 3" },
      { id: 112, title: "Input & Output Devices", preview: computerBasicsImg, category: "Computer Science", grade: "Grade 3" },
      { id: 113, title: "Keyboard Practice", preview: computerBasicsImg, category: "Computer Science", grade: "Grade 3" },
      { id: 114, title: "Using a Mouse", preview: computerBasicsImg, category: "Computer Science", grade: "Grade 3" },
      { id: 115, title: "Internet Safety Basics", preview: computerBasicsImg, category: "Computer Science", grade: "Grade 3" },
    ],
    assignments: [
      { id: 34, title: "Grade 3 Practice Assignment", preview: assignmentsPracticeImg, category: "Assignments", grade: "Grade 3" },
      { id: 121, title: "Weekly Test - Math & Science", preview: assignmentsTestsImg, category: "Assignments", grade: "Grade 3" },
      { id: 122, title: "Monthly Assessment - All Subjects", preview: assignmentsTestsImg, category: "Assignments", grade: "Grade 3" },
      { id: 123, title: "Revision Worksheet - Term 2", preview: assignmentsRevisionImg, category: "Assignments", grade: "Grade 3" },
    ],
  },
  "grade-4": {
    math: [
      { id: 23, title: "Division Practice", preview: mathDivisionImg, category: "Math", grade: "Grade 4" },
      { id: 46, title: "Introduction to Fractions", preview: mathFractionsImg, category: "Math", grade: "Grade 4" },
    ],
    english: [
      { id: 24, title: "Essay Writing", preview: englishEssayImg, category: "English", grade: "Grade 4" },
    ],
    science: [
      { id: 25, title: "Solar System", preview: scienceSolarSystemImg, category: "Science", grade: "Grade 4" },
      { id: 47, title: "Our Solar System", preview: scienceSolarSystemImg, category: "Science", grade: "Grade 4" },
    ],
    computer: [
      { id: 129, title: "MS Paint Basics", preview: computerBasicsImg, category: "Computer Science", grade: "Grade 4" },
      { id: 130, title: "File Management", preview: computerBasicsImg, category: "Computer Science", grade: "Grade 4" },
      { id: 131, title: "Introduction to MS Word", preview: computerBasicsImg, category: "Computer Science", grade: "Grade 4" },
      { id: 132, title: "Email Basics", preview: computerBasicsImg, category: "Computer Science", grade: "Grade 4" },
      { id: 133, title: "Computer Viruses & Safety", preview: computerBasicsImg, category: "Computer Science", grade: "Grade 4" },
    ],
    assignments: [
      { id: 35, title: "Grade 4 Test Paper", preview: assignmentsTestsImg, category: "Assignments", grade: "Grade 4" },
      { id: 139, title: "Weekly Quiz - English & Math", preview: assignmentsTestsImg, category: "Assignments", grade: "Grade 4" },
      { id: 140, title: "Monthly Test - Mathematics", preview: assignmentsTestsImg, category: "Assignments", grade: "Grade 4" },
      { id: 141, title: "Revision Pack - Mid-Term", preview: assignmentsRevisionImg, category: "Assignments", grade: "Grade 4" },
    ],
  },
  "grade-5": {
    math: [
      { id: 26, title: "Fractions & Decimals", preview: mathFractionsImg, category: "Math", grade: "Grade 5" },
      { id: 48, title: "Decimals and Place Value", preview: mathDecimalsImg, category: "Math", grade: "Grade 5" },
    ],
    english: [
      { id: 27, title: "Advanced Grammar", preview: englishGrammarImg, category: "English", grade: "Grade 5" },
      { id: 49, title: "Essay Writing and Paragraph Structure", preview: englishEssayImg, category: "English", grade: "Grade 5" },
    ],
    science: [
      { id: 28, title: "Physics Basics", preview: scienceExperimentsImg, category: "Science", grade: "Grade 5" },
    ],
    computer: [
      { id: 147, title: "MS PowerPoint Basics", preview: computerBasicsImg, category: "Computer Science", grade: "Grade 5" },
      { id: 148, title: "Introduction to Spreadsheets", preview: computerBasicsImg, category: "Computer Science", grade: "Grade 5" },
      { id: 149, title: "Coding Basics - Scratch", preview: computerBasicsImg, category: "Computer Science", grade: "Grade 5" },
      { id: 150, title: "Internet & Search Engines", preview: computerBasicsImg, category: "Computer Science", grade: "Grade 5" },
      { id: 151, title: "Cyber Security for Kids", preview: computerBasicsImg, category: "Computer Science", grade: "Grade 5" },
    ],
    assignments: [
      { id: 36, title: "Grade 5 Comprehensive Test", preview: assignmentsTestsImg, category: "Assignments", grade: "Grade 5" },
      { id: 157, title: "Pre-Board Examination", preview: assignmentsTestsImg, category: "Assignments", grade: "Grade 5" },
      { id: 158, title: "Final Revision - All Subjects", preview: assignmentsRevisionImg, category: "Assignments", grade: "Grade 5" },
      { id: 159, title: "Sample Paper - Term 1", preview: assignmentsPracticeImg, category: "Assignments", grade: "Grade 5" },
    ],
  },
};
